      ...
      <div className="flex-1 px-4 pb-8 space-y-3">
        <button className="w-full bg-gray-900 rounded-2xl px-4 py-5 text-left flex items-center gap-4" onClick={() => navigate('/admin/clients')}>
          ...
          <div>
            ...
            <div className="text-sm text-gray-500">Treninzi i ishrana po vežbaču</div>
          </div>
        </button>

        <button className="w-full bg-gray-900 rounded-2xl px-4 py-5 text-left flex items-center gap-4" onClick={() => navigate('/admin/exercises')}>
          ...
          <div>
            <div className="font-semibold text-lg">Vežbe</div>
            <div className="text-sm text-gray-500">Biblioteka vežbi sa video snimcima</div>
          </div>
        </button>
      </div>
    </div>
